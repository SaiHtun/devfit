...
CREATE TYPE "public"."customizable_area" AS ENUM('front', 'back', 'left_hand', 'right_hand');--> statement-breakpoint
CREATE TYPE "public"."gender_type" AS ENUM('unisex', 'men', 'women');--> statement-breakpoint
CREATE TYPE "public"."product_category" AS ENUM('t-shirt', 'polo-shirt', 'hoodie', 'tote-bag');--> statement-breakpoint
